...
export function createTestConfig(overrides: Partial<ComputerUseConfig> = {}): ComputerUseConfig {
  ...
  return {
    ...
    workspaceMemoryPlastMemPreRetrieve: {
      enabled: overrides.workspaceMemoryPlastMemPreRetrieve?.enabled ?? baseConfig.workspaceMemoryPlastMemPreRetrieve.enabled,
      baseUrl: overrides.workspaceMemoryPlastMemPreRetrieve?.baseUrl ?? baseConfig.workspaceMemoryPlastMemPreRetrieve.baseUrl,
      conversationId: overrides.workspaceMemoryPlastMemPreRetrieve?.conversationId ?? baseConfig.workspaceMemoryPlastMemPreRetrieve.conversationId,
      apiKey: overrides.workspaceMemoryPlastMemPreRetrieve?.apiKey ?? baseConfig.workspaceMemoryPlastMemPreRetrieve.apiKey,
      timeoutMs: overrides.workspaceMemoryPlastMemPreRetrieve?.timeoutMs ?? baseConfig.workspaceMemoryPlastMemPreRetrieve.timeoutMs,
      semanticLimit: overrides.workspaceMemoryPlastMemPreRetrieve?.semanticLimit ?? baseConfig.workspaceMemoryPlastMemPreRetrieve.semanticLimit,
      maxChars: overrides.workspaceMemoryPlastMemPreRetrieve?.maxChars ?? baseConfig.workspaceMemoryPlastMemPreRetrieve.maxChars,
      detail: overrides.workspaceMemoryPlastMemPreRetrieve?.detail ?? baseConfig.workspaceMemoryPlastMemPreRetrieve.detail,
      category: overrides.workspaceMemoryPlastMemPreRetrieve?.category ?? baseConfig.workspaceMemoryPlastMemPreRetrieve.category,
    },
    binaries: {
