...
| Planning orchestration contract | `planning-orchestration-contract.md`, `src/planning-orchestration/contract.ts`, `src/planning-orchestration/projection.ts`, `src/planning-orchestration/reconciliation.ts`, `src/planning-orchestration/state-transition.ts`, `src/planning-orchestration/host-entrypoint.ts`, `src/planning-orchestration/lane-router.ts`, `src/planning-orchestration/route-projection.ts`, `src/planning-orchestration/workflow-handoff.ts`, `src/planning-orchestration/workflow-mapping.ts`, `src/planning-orchestration/workflow-execution.ts`, `src/planning-orchestration/workflow-evidence.ts`, `src/planning-orchestration/workflow-reconciliation.ts`, `src/coding-runner/transcript-runtime.ts` | `src/planning-orchestration/contract.test.ts`, `src/planning-orchestration/projection.test.ts`, `src/planning-orchestration/reconciliation.test.ts`, `src/planning-orchestration/state-transition.test.ts`, `src/planning-orchestration/host-entrypoint.test.ts`, `src/planning-orchestration/lane-router.test.ts`, `src/planning-orchestration/route-projection.test.ts`, `src/planning-orchestration/workflow-handoff.test.ts`, `src/planning-orchestration/workflow-mapping.test.ts`, `src/planning-orchestration/workflow-execution.test.ts`, `src/planning-orchestration/workflow-evidence.test.ts`, `src/planning-orchestration/workflow-reconciliation.test.ts`, `src/coding-runner/transcript-runtime.test.ts` | Future cross-lane PlanSpec/PlanState authority, optional context projection, evidence reconciliation, deterministic state-transition proposals, host-owned proposal review entrypoint, deterministic lane-routing classification, route-summary projection, workflow handoff classification, explicit workflow template mapping, explicit mapped workflow execution boundary, workflow-result-to-plan-evidence bridge, and explicit workflow reconciliation summary. No host planner auto-execution. |
...
| `src/planning-orchestration/contract.ts`, `src/planning-orchestration/projection.ts`, `src/planning-orchestration/reconciliation.ts`, `src/planning-orchestration/state-transition.ts`, `src/planning-orchestration/host-entrypoint.ts`, `src/planning-orchestration/lane-router.ts`, `src/planning-orchestration/route-projection.ts`, `src/planning-orchestration/workflow-handoff.ts`, `src/planning-orchestration/workflow-mapping.ts`, `src/planning-orchestration/workflow-execution.ts`, `src/planning-orchestration/workflow-evidence.ts`, `src/planning-orchestration/workflow-reconciliation.ts`, or plan projection wiring in `src/coding-runner/transcript-runtime.ts` | `pnpm -F @proj-airi/computer-use-mcp exec vitest run src/planning-orchestration/contract.test.ts src/planning-orchestration/projection.test.ts src/planning-orchestration/reconciliation.test.ts src/planning-orchestration/state-transition.test.ts src/planning-orchestration/host-entrypoint.test.ts src/planning-orchestration/lane-router.test.ts src/planning-orchestration/route-projection.test.ts src/planning-orchestration/workflow-handoff.test.ts src/planning-orchestration/workflow-mapping.test.ts src/planning-orchestration/workflow-execution.test.ts src/planning-orchestration/workflow-evidence.test.ts src/planning-orchestration/workflow-reconciliation.test.ts src/coding-runner/transcript-runtime.test.ts` |
